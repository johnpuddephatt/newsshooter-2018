...
<div class="entry-meta">
  ...
  <div class="entry-byline">
    @if ((get_the_author_meta('nickname') != 'Newsshooter') &&
    (get_the_author_meta('first_name') or get_the_author_meta('last_name')))
    @if(is_single($post->ID))
    <div class="entry-byline--image">
      {!! get_avatar(get_the_author_meta( 'ID' ), 64, '' , 'Image of' .
      get_the_author_meta('first_name') . get_the_author_meta('last_name') ,
      array('class' => 'is-rounded') ) !!}
    </div>
    @endif
    <a
